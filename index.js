...
try {
  registerFont(path.join(__dirname, "fonts", "Nunito-Bold.ttf"), {
    family: FONT_FAMILY,
    weight: "700",
  });

  registerFont(path.join(__dirname, "fonts", "Nunito-ExtraBold.ttf"), {
    family: FONT_FAMILY,
    weight: "800",
  });
  ...
  console.warn("⚠️ Police Nunito introuvable. Police système utilisée à la place.");
}
